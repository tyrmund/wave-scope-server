...
router.post("/", (req, res, next) => {
    ...
    const { images, name, latitude, longitude, busStops, length, composition, sectors } = req.body
    ...
    Beach
        .create({ images, name, location, busStopCoords: busStopCoordinates, length, composition, sectors })
